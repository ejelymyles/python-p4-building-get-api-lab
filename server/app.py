...
def baked_goods_by_price():
    baked_goods_by_price = [baked_good.to_dict() for baked_good in BakedGood.query.order_by(BakedGood.price.desc()).all()]
    #baked_goods_dict = baked_goods_by_price.to_dict()
